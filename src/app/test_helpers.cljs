...
(def pulled-lethal-weapon-snapshot
  {:db/id 54
   :movie/cast [{:db/id 13, :person/born "1956-01-03", :person/name "Mel Gibson"}
                {:db/id 14, :person/born "1946-07-22", :person/name "Danny Glover"}
                {:db/id 15, :person/born "1944-07-29", :person/name "Gary Busey"}]
   :movie/director [{:db/id 12, :person/born "1930-04-24", :person/name "Richard Donner"}]
   :movie/sequel -212
